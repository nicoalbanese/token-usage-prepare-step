...
<Note>
  ...
  [ToolLoopAgent documentation](https://ai-sdk.dev/docs/reference/ai-sdk-core/tool-loop-agent).
</Note>
...
import { type InferAgentUIMessage, type LanguageModelUsage, ToolLoopAgent, tool } from "ai";
import { z } from "zod";
